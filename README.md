...
<h1 class="title">Build-a-Bonus</h1>

<p class="winnar">2022 Package Jam winner of the 'Most Polished' category and runner-up for 'Best Package'</p>
...
<p class="img"><img src="https://i.imgur.com/PEtyFfQ.png"></p>
...
<p class="img"><img src="https://i.imgur.com/Ygf0fPE.png"></p>
...
<p class="img"><img src="https://i.imgur.com/OnLz50Y.png"></p>
...
<h1 class="header">Bonus Creation and Configuration</h1>
...
<h2 class="header">Required Fields</h2>
...
<h2 class="header">Aura and Template Configuration</h2>
...
<h3 class="header">Optional Bonuses and Consumption</h3>
...
<h1 class="header">Available Filters</h1>
